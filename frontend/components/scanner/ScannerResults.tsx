    ...
    <>
      {results.map((food) => {
        const nutritionItems = [
          ...
          ...(food.nutrition.calcium != null ? [{ label: '鈣', value: food.nutrition.calcium, unit: 'mg', color: '#EAB308' }] : []),
          ...(food.nutrition.iron != null ? [{ label: '鐵', value: food.nutrition.iron, unit: 'mg', color: '#EF4444' }] : []),
        ];
