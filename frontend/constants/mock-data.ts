...
export const DAILY_NUTRITION = {
  ...
  calcium: { current: 650, target: 1000, unit: 'mg', color: '#EAB308', label: '鈣' },
  iron: { current: 11.2, target: 15, unit: 'mg', color: '#EF4444', label: '鐵' },
};
...
export const SCANNER_DEMO_RESULTS: DetectedFood[] = [
  {
    ...
    estimatedWeight: 200,
    nutrition: { calories: 260, protein: 5, carbs: 57, fat: 0.6, sodium: 2, fiber: 0.6, calcium: 10, iron: 0.8 },
    gi: 'high',
    allergens: ['麩質'],
  ...
  },
  {
    ...
    estimatedWeight: 80,
    nutrition: { calories: 225, protein: 18, carbs: 5, fat: 15, sodium: 680, fiber: 0, calcium: 15, iron: 1.5 },
    gi: 'low',
    allergens: ['大豆'],
  ...
  },
  {
    ...
    estimatedWeight: 120,
    nutrition: { calories: 35, protein: 3, carbs: 4, fat: 0.5, sodium: 15, fiber: 3.2, calcium: 120, iron: 2.1 },
    gi: 'low',
    allergens: [],
    warnings: [],
  },
